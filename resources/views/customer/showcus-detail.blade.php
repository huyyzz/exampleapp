...
{{--                    <div class="float-right">--}}
{{--                        <a href='{{ route('customer.home') }}' class="btn btn-warning btn-lg ">Back</a>--}}
{{--                    </div>--}}
                    <div class="pt-4">
                        <h6 class="mb-0"><a href='{{ route('customer.home') }}' class="text-body"><i
                                    class="fas fa-long-arrow-alt-left me-2"></i>Back to shop</a></h6>
                    </div>

                    <img src="{{ asset('storage/images/' . $cloth->product_image_url) }} "  height="450" alt="Product Image" >
                    <div class="card-body">
